...
# =========================
ADRESSE_REGEX_bis = r"(RUE|R\.|AVENUE|AV\.|COURS|COUR|CHEE|GRAND ROUTE|ROND-POINT|CHAUSS[ÉE]E|ROUTE|RTE|PLACE|PL\.?|BOULEVARD|BD|CHEMIN|CH\.?|GALERIE|IMPASSE|SQUARE|ALL[ÉE]E|CLOS|RESIDENCE|VOIE|RY|PASSAGE|QUAI|PARC|Z\.I\.?|ZONE|SITE|PROMENADE|FAUBOURG|FBG|QUARTIER|CITE|DREVE|HAMEAU|LOTISSEMENT|NEBLON)"
